...
VALUES
  (
    ...
    'admin@admin.com',
    '',
    'hx80zzMRLTYqKG43T0gs2u49853bc07e5b4dce65',
    1409048402,
    'vOurF415533zJChPxZUj/e',
    1268889823,
    1409048715,
    1,
    'Admin',
...
ALTER TABLE
  `transaction`
ADD
  CONSTRAINT `fk` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
