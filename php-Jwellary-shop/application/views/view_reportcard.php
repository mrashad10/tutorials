    ...
    <div class="col-md-12">
        ...
        <div id="report-response" style="padding-left:12%">
            ...
            <table class="metro table">
                <thead>
                    <tr>
                        <td colspan="6" style="padding: 0px;"><span class="table-heading"><?php echo $item ?> - transaction report</span></td>
                    </tr>
                </thead>
                <thead>
                    <tr>
                        <th>SNO</th>
                        <th>WEIGHT<small><sub>(grms)</sub></small></th>
                        <th>QUANTITY</th>
                        <th>TOTAL Weight<small><sub>(grms)</sub></small></th>
                        <th>TYPE</th>
                        <th>DATE</th>
                    </tr>
                </thead>
