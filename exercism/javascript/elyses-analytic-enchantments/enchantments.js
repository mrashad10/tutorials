 ...
 */
export const isEachCardEven = stack => stack.every(element => element % 2 === 0)
...
export const doesStackIncludeOddCard = stack =>
  stack.some(element => element % 2 !== 0)
 ...
 */
export const getFirstOddCard = stack => stack.find(element => element % 2 !== 0)
...
export const getFirstEvenCardPosition = stack =>
  stack.findIndex(element => element % 2 === 0)
