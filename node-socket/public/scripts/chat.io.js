(function ($) {
  ...
  function bindSocketEvents() {
    ...
    socket.on("roomclients", function (data) {
      ...
      insertMessage(
        serverDisplayName,
        "Welcome to the room: `" + data.room + "`... enjoy!",
        true,
        false,
        true
      );
  ...
  function addClient(client, announce, isMe) {
    ...
    if (announce) {
      insertMessage(
        serverDisplayName,
        client.nickname + " has joined the room...",
        true,
        false,
        true
      );
  ...
  function removeClient(client, announce) {
    ...
    if (announce) {
      insertMessage(
        serverDisplayName,
        client.nickname + " has left the room...",
        true,
        false,
        true
      );
