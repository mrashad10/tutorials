...
[![Latest Stable Version](https://poser.pugx.org/mrashad10/bootstrap-fileinput/v/stable)](https://packagist.org/packages/mrashad10/bootstrap-fileinput)
[![License](https://poser.pugx.org/mrashad10/bootstrap-fileinput/license)](https://packagist.org/packages/mrashad10/bootstrap-fileinput)
[![Packagist Downloads](https://poser.pugx.org/mrashad10/bootstrap-fileinput/downloads)](https://packagist.org/packages/mrashad10/bootstrap-fileinput)
[![Monthly Downloads](https://poser.pugx.org/mrashad10/bootstrap-fileinput/d/monthly)](https://packagist.org/packages/mrashad10/bootstrap-fileinput)
...
> NOTE: The latest version of the plugin is v4.3.2 (dev-master). Refer the [CHANGE LOG](https://github.com/mrashad10/bootstrap-fileinput/blob/master/CHANGE.md) for details. 
...
> NOTE: You can use the [sass branch](https://github.com/mrashad10/bootstrap-fileinput/tree/sass) for installation using `bootstrap-sass` dependency.
The [master branch](https://github.com/mrashad10/bootstrap-fileinput/tree/master) can be used for installation using plain `bootstrap` dependency.
...
You can use the `composer` package manager to install. Either run:
    ...
    $ php composer.phar require mrashad10/bootstrap-fileinput "@dev"

or add:

    "mrashad10/bootstrap-fileinput": "@dev"

to your composer.json file

### Manual Install

You can also manually install the plugin easily to your project. Just download the source [ZIP](https://github.com/mrashad10/bootstrap-fileinput/zipball/master) or [TAR ball](https://github.com/mrashad10/bootstrap-fileinput/tarball/master) and extract the plugin assets (css and js folders) into your project.
